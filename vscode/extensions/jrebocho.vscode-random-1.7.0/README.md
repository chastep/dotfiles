...
You can check all the changes in the change log [here](https://github.com/jrebocho/vscode-random/blob/master/CHANGELOG.md).
...
[MIT](https://github.com/jrebocho/vscode-random/blob/master/LICENSE) &copy; Jorge Rebocho
