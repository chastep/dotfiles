...
alias dcwebcon="dcrun web rails c"
alias dps="docker ps"
alias da="docker attach"
alias docker-scorch="dc stop && dc rm -f && ds stop && ds clean && dc build && ds start -f"
alias docker-old-file="dcrun web bundle exec rake db:restore:file["tmp/database/$(ls -tR ./tmp/database | head -n1)"] && dcrun web bundle exec rake db:migrate && dc up -d"
